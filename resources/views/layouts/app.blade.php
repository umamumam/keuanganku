        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="/transactions/report" class="pc-link">
        ...
        <div class="footer-wrapper container-fluid">
            <div class="row">
                <div class="col-sm my-1">
                    <p class="m-0">Develop &#9829; Sistem <a href="https://github.com/umamumam" target="_blank">By
                        </a><a href="https://github.com/umamumam">MFTHLMM</a>.</p>
                </div>
